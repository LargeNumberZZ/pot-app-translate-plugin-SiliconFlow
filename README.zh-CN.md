...
| `tencent/Hunyuan-MT-7B` | 以上所有环节的兜底 + 查词头 1 至 2 秒的**临时**快速译文预览（千问词典卡片就绪后自动替换，简明卡片本身是千问生成的） |

## 功能特性

- **单词 / 短语词典卡片**：英美音标 + 按词性分组的词义（千问生成）。底部"详细解释"链接按需加载详尽版：更多释义、搭配、屈折变化、近义词与两组例句，返回与刷新瞬时切换。
